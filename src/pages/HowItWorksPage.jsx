import { CheckCircle, Users, Shield, Zap, TrendingUp, Heart, Globe } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      description: 'Tell your story and set your fundraising goal. Our guided setup takes just minutes.',
      details: [
      ...
      image: 'https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=800&h=600&fit=crop&q=80',
    },
    {
      number: '02',
      title: 'Share with your network',
      description: 'Reach potential donors through multiple channels with our built-in sharing tools.',
      details: [
    ...
    },
    {
      ...
      description: 'Accept secure donations from supporters around the world with multiple payment options.',
      details: [
    ...
    },
    {
      ...
      description: 'Access your funds quickly and easily with flexible withdrawal options.',
      details: [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-24">
            {steps.map((step, index) => (
              ...
              >
                <div className={`${index % 2 === 1 ? 'md:order-2' : ''} animate-fadeIn`}>
                  <div className="inline-block px-4 py-2 bg-amber-100 text-amber-800 rounded-full text-sm font-bold mb-4">
                    STEP {step.number}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="text-center group hover:shadow-xl"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-amber-100 rounded-xl mb-4 group-hover:bg-amber-600 transition-colors">
                    <Icon className="w-8 h-8 text-amber-700 group-hover:text-white transition-colors" />
                  </div>
