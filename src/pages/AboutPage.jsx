import { Target, Users, Heart, Shield, TrendingUp, Globe, Award, Lightbulb } from 'lucide-react';
...
export default function AboutPage() {
  const values = [
    ...
    },
    {
      icon: Shield,
      title: 'Trust & Safety',
      description: 'Your security and trust are paramount. We maintain the highest standards of platform integrity.',
    },
    {
      icon: Users,
      title: 'Community Driven',
      description: 'Our platform thrives on the strength and generosity of our global community.',
    },
    {
      icon: Lightbulb,
      title: 'Innovation',
      description: 'We continuously evolve to provide the best fundraising experience possible.',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              To empower people everywhere to raise money for the causes they care about, making fundraising accessible, transparent, and impactful for everyone.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  FundRise began with a simple belief: that everyone deserves access to financial support when they need it most. Founded in 2020, we set out to create a platform that would break down barriers to fundraising and make it easy for anyone to rally support around their cause.
                </p>
                <p>
                  What started as a small team with big dreams has grown into a global platform serving millions. We've helped people raise funds for medical treatments, disaster relief, education, creative projects, and countless other causes.
                </p>
                <p>
                  Today, we're proud to be the world's leading crowdfunding platform, but our mission remains the same: to empower people to turn their compassion into action and make a real difference in the lives of others.
                </p>
              </div>
            </div>
                ...
                >
                  <div className={`w-5/12 ${index % 2 === 0 ? 'text-right pr-8' : 'text-left pl-8'}`}>
                    <Card className="inline-block">
                      <div className="text-amber-700 font-bold text-lg mb-2">{milestone.year}</div>
