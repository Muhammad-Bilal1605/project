...
export default function FeaturedFundraisers() {
  ...
  const goToPrevious = () => {
    ...
    setCurrentIndex((prev) => (prev === 0 ? fundraisers.length - slidesToShow : prev - 1));
  ...
  const goToNext = () => {
    if (isTransitioning) return;
    setIsTransitioning(true);
    setCurrentIndex((prev) => (prev + 1) % (fundraisers.length - slidesToShow + 1));
    setTimeout(() => setIsTransitioning(false), 500);
  };
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-12">
          ...
          <div className="hidden md:flex gap-2">
            <button 
              ...
              className="w-10 h-10 rounded-lg border border-gray-300 flex items-center justify-center hover:bg-gray-50 transition-colors disabled:opacity-50"
              aria-label="Previous"
            >
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative h-56 overflow-hidden">
                      ...
                      {/* Like button */}
                      <button className="absolute top-4 right-4 w-9 h-9 bg-white/95 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-amber-600 hover:text-white transition-colors">
        ...
        <div className="flex justify-center gap-2 mt-8">
          {Array.from({ length: fundraisers.length - slidesToShow + 1 }).map((_, index) => (
            <button
              key={index}
