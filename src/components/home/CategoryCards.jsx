...
import { Heart, AlertCircle, GraduationCap, Building2, Users, PawPrint, Briefcase, Home, ArrowRight } from 'lucide-react';
  ...
  const categories = [
    {
      name: 'Medical',
      icon: Heart,
      description: 'Help cover medical bills and treatment costs',
    ...
    },
    {
      name: 'Emergency',
      icon: AlertCircle,
      description: 'Support urgent crisis and disaster relief',
    ...
    },
    {
      name: 'Education',
      icon: GraduationCap,
      description: 'Fund tuition and learning programs',
    ...
    },
    {
      name: 'Community',
      icon: Users,
      description: 'Build stronger neighborhoods',
    ...
    },
    {
      name: 'Animals',
      icon: PawPrint,
      description: 'Rescue and care for pets',
    ...
    },
    {
      name: 'Business',
      icon: Briefcase,
      description: 'Launch and grow ventures',
            ...
            return (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <button className="text-amber-700 font-medium text-sm flex items-center gap-1 group-hover:gap-2 transition-all">
                    Get started
